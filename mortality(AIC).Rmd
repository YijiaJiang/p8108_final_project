...
From this log-rank test, we get a p-value that is closed to 0.003, which is significant at a 0.05 level. We want to conclude that there is a significant difference among the three treatments in the mortality model.
