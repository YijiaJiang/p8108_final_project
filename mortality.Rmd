...
From the results of the summary function for the final mortality model, we see that after we control for all other covariates in the model the coefficient for rx2 and rx3 are both significant with p-value of 0.00573 and 0.00579 compared with the observation group, respectively. 
...
Because the covariates are time-varying, we consider taking them into account in our model by handling with 'log(time)' to protect our assumption. Our final model is given by: Surv(time, status) ~ obstruct + differ + extent + surg + node4 + rx + obstructt + differt + extentt + surgt + rxt + node4t.

Our result indicates that the hazard ratio for the group treated with rx2 is 6.78, corresponds to a 87.1% chance of longer suvival compared to the observation group. Since the p-value for the coefficient is 0.00573 which is smaller than 0.05, there is significant evidence to indicate a difference between the hazard rate of the group treated with rx2 and the hazard rate of the observation group. Therefore, we conclude that the treatment rx2 is effective on improving the survival probability in colon cancer patients.

On the other hand, our result indicates that the hazard ratio for the group treated with rx3 is 4.35, corresponds to a 81.3% chance of longer suvival compared to the observation group. Since the p-value for the coefficient is 0.00579 which is smaller than 0.05, there is significant evidence to indicate a difference between the hazard rate of the group treated with rx2 and the hazard rate of the observation group. Therefore, we conclude that the treatment rx2 is effective on improving the survival probability in colon cancer patients.

Therefore, we conclude that the treatment Levamisole and Levamisole+5-FU are both effective on improving the survival rate in colon cancer patients.
